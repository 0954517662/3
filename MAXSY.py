...
settings = {
    ...
    "unsendMessage": True,
    "autoJoinTicket": True,
    "welcome":"Welcome to group ^_^",
    "kick":"อ่อน ไอ่เหี้ย เตะคนไม่มีทางสู้ (~_^)",
    "bye":"Good bye ʕ•ﻌ•ʔ",
    "Respontag":"THANKS FOR TAG ME ^.^",
    ...
    "pname": {},
    "pro_name": {},
    "message1":"THANK FOR ADD ME 😊",
    "messageadd":"AUTO BLOCK",
    "message1":"AUTO BLOCK",
    "comment1":"MAX",
    "comment":"MAX",
    "userAgent": [
...
#==============================================================================#
                ...
                elif "แม็คหล่อ" in msg.text:
                    spl = msg.text.split("แม็คหล่อ")
                    if spl[len(spl)-1] == "":
...
#==============================================================================#
        ...
        if op.type == 26:
            ...
            if settings ["Api"] == True:
            	if msg.text in ["แม็คหล่อ","แม็ครวย","ลุง","หรรม","นาย","เพื่อน","จาร์ย","อาจาร์ย","เฮีย"]:
                    line.sendMessage(msg.to, str(settings["comment"]))
            if settings ["Api"] == True:
